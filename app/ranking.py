...
TOPICS = {
    "ai-ml": {
        ...
        "keywords": [
            ...
            "neural network", "transformer", "llm", "gpt", "chatgpt", 
            "openai", "anthropic", "claude", "gemini", "ollama",
            # Specific ML concepts
            "embeddings", "vector", "rag", "fine-tuning", "training",
            "inference", "pytorch", "tensorflow", "hugging face",
            "stable diffusion", "computer vision", "nlp", "generative",
            # Business AI
            "ai startup", "ai tools", "copilot", "ai assistant"
        ],
    ...
    "security": {
        ...
        "keywords": [
            ...
            "malware", "ransomware", "phishing", "cybersecurity",
            # Crypto/blockchain
            "blockchain", "cryptocurrency", "bitcoin", "ethereum",
            "web3", "smart contract", "defi", "nft",
            # Security practices
            "authentication", "authorization", "encryption", "tls",
            "certificate", "zero trust", "penetration test"
        ],
    ...
    "devtools": {
        ...
        "keywords": [
            ...
            "c++", "swift", "kotlin", "ruby", "php",
            # Development tools
            "vscode", "github", "gitlab", "git", "ide", "editor",
            "framework", "library", "api", "rest", "graphql",
            # Web development
            "react", "vue", "angular", "node", "fastapi", "django",
            "nextjs", "svelte", "web development", "frontend", "backend"
        ],
        "weight": 1.0
    },
    "chips-hardware": {
        ...
        "keywords": [
            ...
            "memory", "storage", "ssd", "ram", "silicon",
            # Manufacturing
            "tsmc", "samsung", "fab", "foundry", "node", "nm",
...
class RankingCalculator:
    ...
    def calculate_score(
        ...
        components = {
            ...
            "topic_multiplier": TOPICS.get(topic, {}).get("weight", 1.0) if topic else 1.0,
            "final": total_score
        }
...
class TopicClassifier:
    ...
    def classify_article(
        ...
        return result if result.topic else TopicResult(
            topic=None, 
            confidence=0.0, 
            method="fallback",
            matched_keywords=[]

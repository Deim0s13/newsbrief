...
|----------|-------------|
| [GITHUB_PROJECT_BOARD_SETUP.md](GITHUB_PROJECT_BOARD_SETUP.md) | How the project board is configured |
| [SECURITY_ACCEPTED_RISKS.md](SECURITY_ACCEPTED_RISKS.md) | Documented security decisions |
...
**Note**: GitHub is the source of truth for all project planning and issue tracking.
